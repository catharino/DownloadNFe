...
namespace ConsultaXMLNFe
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            NFe_Rec.ClientCredentials.ClientCertificate.SetCertificate(StoreLocation.CurrentUser, StoreName.My, X509FindType.FindBySerialNumber, "‎60688BC760CD7647");

            var notas = new string[] {"35170810501763000170550010000701381000000018"}; // este array não deve passar de 20 elementos, máximo permitido por lote de manifestação
...
<CNPJ>24430356000123</CNPJ>
<consChNFe>
    <chNFe>35170810501763000170550010000701381000000018</chNFe>
</consChNFe>
</distDFeInt>";
        ...
        private void BaixarXml(XmlDocument xml)
        {
            ...
            NFe_Sc.ClientCredentials.ClientCertificate.SetCertificate(StoreLocation.CurrentUser, StoreName.My, X509FindType.FindBySerialNumber, "60688BC760CD7647");
