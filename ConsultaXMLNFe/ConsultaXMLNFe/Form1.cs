...
namespace ConsultaXMLNFe
{
    public partial class Form1 : Form
    {
        ...
        private void BaixarXml(XmlDocument xml)
        {
            ...
            NFe_Sc.ClientCredentials.ClientCertificate.SetCertificate(StoreLocation.CurrentUser, StoreName.My, X509FindType.FindBySerialNumber, "SERIAL DO CERTIFICADO"); // <- sem espaços e tudo em caixa alta
